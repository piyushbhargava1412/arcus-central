...
| What | How | Why |
|------|-----|-----|
| `.arcus/` (templates, scripts, instructions) | **Symlinks** to central repo | Zero duplication, instant updates |
...
| `arcus-integrate --remove`  | Remove managed integration artifacts (preserves `.arcus/instructions`) |
...
| `.arcus/instructions`          | Dir symlink          | `central/instructions`                  | Engineering guidelines |
...
│   └── instructions → ../../arcus-central/instructions
│
├── .github/
...
- **9 Agents** (6 core + 3 extensions): `specify`, `clarify`, `plan`, `tasks`, `analyze`, `implement`, `context-builder`, `groom`, `instructions`
...
### Shared Templates, Scripts, Instructions & Skills
...
- **Instructions** (5): Engineering, architecture, language, infrastructure, and testing guidelines
