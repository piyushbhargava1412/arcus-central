...
│   └── testing-patterns.md
│
├── AGENTS.md                  ← Generated during bootstrap (Stage 2)
...
- **10 Agents** (6 core + 4 extensions): `specify`, `clarify`, `plan`, `tasks`, `analyze`, `implement`, `context-builder`, `groom`, `instructions`, `close`
- **10 Prompts** (6 core + 4 extensions): Corresponding prompts for all agents
...
**What is preserved:**
- ✅ `.arcus/guidelines/` (symlink) — developers may reference this in their `AGENTS.md`
