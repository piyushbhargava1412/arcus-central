...
5. Run `reasoning/coverage-analysis` as a preflight gate to ensure tasks sufficiently cover the approved requirements within the scoped story context; if gaps exist, surface them and halt unless the user explicitly overrides.
