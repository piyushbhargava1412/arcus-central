...
6. **Validation**: Apply **Markdown Validation Skills** (see `skills/markdown-validation/SKILL.md`) after EACH write plus final pass. Additionally verify:
...
8. Report completion via chat output only (no separate files):
