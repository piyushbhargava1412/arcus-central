...
4. **Generate tasks.md**: Use `.apex/templates/tasks-template.md` as structure, fill with:
...
5. **Report**: Output summary ONLY to chat (do NOT create any summary files):
   ...
   - **CRITICAL**: Only create tasks.md file - do NOT create INDEX.md, ANALYSIS.md, or any other summary files
