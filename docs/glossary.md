...
**Skill**
A reusable, single-purpose capability with explicit input/output contracts. Skills are called by agents, not by other skills. Examples: quality-gates, artifact-modeling, dependency-analysis. ARCUS has 23 skills organized into 10 categories.
