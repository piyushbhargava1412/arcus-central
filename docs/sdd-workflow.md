...
- [Philosophy](philosophy.md) — Why this workflow matters
- [Architecture](architecture.md) — Design rationale for each stage
- [Context System](context-system.md) — How context flows through the workflow
