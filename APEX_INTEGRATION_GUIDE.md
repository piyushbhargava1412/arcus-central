...
2. **`.github/prompts/*.prompt.md`** — available for SDD workflow prompts3. **`.github/skills/`** — referenced by agents for detailed capability definitions
...
| **Phase 2** | Creates flat file symlinks in `.github/agents/` and `.github/prompts/`, skills symlink |
